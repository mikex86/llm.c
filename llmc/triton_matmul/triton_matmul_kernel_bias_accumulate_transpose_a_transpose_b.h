...
$L__BB0_2:
	...
	// end inline asm
	.loc	1 100 35
	mov.b32 	%r909, {%rs661, %rs662};
	mov.b32 	%r910, {%rs663, %rs664};
	mov.b32 	%r919, {%rs665, %rs666};
	mov.b32 	%r920, {%rs667, %rs668};
	mov.b32 	%r929, {%rs669, %rs670};
	mov.b32 	%r930, {%rs671, %rs672};
	mov.b32 	%r939, {%rs673, %rs674};
	mov.b32 	%r940, {%rs675, %rs676};
	mov.b32 	%r949, {%rs677, %rs678};
	mov.b32 	%r950, {%rs679, %rs680};
	mov.b32 	%r959, {%rs681, %rs682};
	mov.b32 	%r960, {%rs683, %rs684};
	mov.b32 	%r969, {%rs685, %rs686};
	mov.b32 	%r970, {%rs687, %rs688};
	mov.b32 	%r979, {%rs689, %rs690};
	mov.b32 	%r980, {%rs691, %rs692};
	mov.b32 	%r989, {%rs693, %rs694};
	mov.b32 	%r990, {%rs695, %rs696};
	mov.b32 	%r999, {%rs697, %rs698};
	mov.b32 	%r1000, {%rs699, %rs700};
	mov.b32 	%r1009, {%rs701, %rs702};
	mov.b32 	%r1010, {%rs703, %rs704};
	mov.b32 	%r1019, {%rs705, %rs706};
	mov.b32 	%r1020, {%rs707, %rs708};
	mov.b32 	%r1029, {%rs709, %rs710};
	mov.b32 	%r1030, {%rs711, %rs712};
	mov.b32 	%r1039, {%rs713, %rs714};
	mov.b32 	%r1040, {%rs715, %rs716};
	mov.b32 	%r1049, {%rs717, %rs718};
	mov.b32 	%r1050, {%rs719, %rs720};
	mov.b32 	%r1059, {%rs721, %rs722};
	mov.b32 	%r1060, {%rs723, %rs724};
	mov.b32 	%r1069, {%rs725, %rs726};
	mov.b32 	%r1070, {%rs727, %rs728};
	mov.b32 	%r1079, {%rs729, %rs730};
	mov.b32 	%r1080, {%rs731, %rs732};
	mov.b32 	%r1089, {%rs733, %rs734};
	mov.b32 	%r1090, {%rs735, %rs736};
	mov.b32 	%r1099, {%rs737, %rs738};
	mov.b32 	%r1100, {%rs739, %rs740};
	mov.b32 	%r1109, {%rs741, %rs742};
	mov.b32 	%r1110, {%rs743, %rs744};
	mov.b32 	%r1119, {%rs745, %rs746};
	mov.b32 	%r1120, {%rs747, %rs748};
	mov.b32 	%r1129, {%rs749, %rs750};
	mov.b32 	%r1130, {%rs751, %rs752};
	mov.b32 	%r1139, {%rs753, %rs754};
	mov.b32 	%r1140, {%rs755, %rs756};
	mov.b32 	%r1149, {%rs757, %rs758};
	mov.b32 	%r1150, {%rs759, %rs760};
	mov.b32 	%r1159, {%rs761, %rs762};
	mov.b32 	%r1160, {%rs763, %rs764};
	mov.b32 	%r1169, {%rs765, %rs766};
	mov.b32 	%r1170, {%rs767, %rs768};
	mov.b32 	%r1179, {%rs769, %rs770};
	mov.b32 	%r1180, {%rs771, %rs772};
	mov.b32 	%r1189, {%rs773, %rs774};
	mov.b32 	%r1190, {%rs775, %rs776};
	mov.b32 	%r1199, {%rs777, %rs778};
	mov.b32 	%r1200, {%rs779, %rs780};
	mov.b32 	%r1209, {%rs781, %rs782};
	mov.b32 	%r1210, {%rs783, %rs784};
	mov.b32 	%r1219, {%rs785, %rs786};
	mov.b32 	%r1220, {%rs787, %rs788};
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r909, %r910 }, { %r1830, %r1831, %r1832, %r1833 }, { %r1814, %r1815 }, { %r909, %r910 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r919, %r920 }, { %r1830, %r1831, %r1832, %r1833 }, { %r1816, %r1817 }, { %r919, %r920 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r929, %r930 }, { %r1830, %r1831, %r1832, %r1833 }, { %r1810, %r1811 }, { %r929, %r930 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r939, %r940 }, { %r1830, %r1831, %r1832, %r1833 }, { %r1812, %r1813 }, { %r939, %r940 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r949, %r950 }, { %r1830, %r1831, %r1832, %r1833 }, { %r1806, %r1807 }, { %r949, %r950 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r959, %r960 }, { %r1830, %r1831, %r1832, %r1833 }, { %r1808, %r1809 }, { %r959, %r960 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r969, %r970 }, { %r1830, %r1831, %r1832, %r1833 }, { %r1802, %r1803 }, { %r969, %r970 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r979, %r980 }, { %r1830, %r1831, %r1832, %r1833 }, { %r1804, %r1805 }, { %r979, %r980 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r989, %r990 }, { %r1826, %r1827, %r1828, %r1829 }, { %r1814, %r1815 }, { %r989, %r990 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r999, %r1000 }, { %r1826, %r1827, %r1828, %r1829 }, { %r1816, %r1817 }, { %r999, %r1000 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1009, %r1010 }, { %r1826, %r1827, %r1828, %r1829 }, { %r1810, %r1811 }, { %r1009, %r1010 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1019, %r1020 }, { %r1826, %r1827, %r1828, %r1829 }, { %r1812, %r1813 }, { %r1019, %r1020 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1029, %r1030 }, { %r1826, %r1827, %r1828, %r1829 }, { %r1806, %r1807 }, { %r1029, %r1030 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1039, %r1040 }, { %r1826, %r1827, %r1828, %r1829 }, { %r1808, %r1809 }, { %r1039, %r1040 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1049, %r1050 }, { %r1826, %r1827, %r1828, %r1829 }, { %r1802, %r1803 }, { %r1049, %r1050 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1059, %r1060 }, { %r1826, %r1827, %r1828, %r1829 }, { %r1804, %r1805 }, { %r1059, %r1060 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1069, %r1070 }, { %r1822, %r1823, %r1824, %r1825 }, { %r1814, %r1815 }, { %r1069, %r1070 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1079, %r1080 }, { %r1822, %r1823, %r1824, %r1825 }, { %r1816, %r1817 }, { %r1079, %r1080 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1089, %r1090 }, { %r1822, %r1823, %r1824, %r1825 }, { %r1810, %r1811 }, { %r1089, %r1090 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1099, %r1100 }, { %r1822, %r1823, %r1824, %r1825 }, { %r1812, %r1813 }, { %r1099, %r1100 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1109, %r1110 }, { %r1822, %r1823, %r1824, %r1825 }, { %r1806, %r1807 }, { %r1109, %r1110 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1119, %r1120 }, { %r1822, %r1823, %r1824, %r1825 }, { %r1808, %r1809 }, { %r1119, %r1120 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1129, %r1130 }, { %r1822, %r1823, %r1824, %r1825 }, { %r1802, %r1803 }, { %r1129, %r1130 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1139, %r1140 }, { %r1822, %r1823, %r1824, %r1825 }, { %r1804, %r1805 }, { %r1139, %r1140 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1149, %r1150 }, { %r1818, %r1819, %r1820, %r1821 }, { %r1814, %r1815 }, { %r1149, %r1150 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1159, %r1160 }, { %r1818, %r1819, %r1820, %r1821 }, { %r1816, %r1817 }, { %r1159, %r1160 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1169, %r1170 }, { %r1818, %r1819, %r1820, %r1821 }, { %r1810, %r1811 }, { %r1169, %r1170 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1179, %r1180 }, { %r1818, %r1819, %r1820, %r1821 }, { %r1812, %r1813 }, { %r1179, %r1180 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1189, %r1190 }, { %r1818, %r1819, %r1820, %r1821 }, { %r1806, %r1807 }, { %r1189, %r1190 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1199, %r1200 }, { %r1818, %r1819, %r1820, %r1821 }, { %r1808, %r1809 }, { %r1199, %r1200 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1209, %r1210 }, { %r1818, %r1819, %r1820, %r1821 }, { %r1802, %r1803 }, { %r1209, %r1210 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1219, %r1220 }, { %r1818, %r1819, %r1820, %r1821 }, { %r1804, %r1805 }, { %r1219, %r1220 };
	// end inline asm
	// begin inline asm
	...
	// end inline asm
	mov.b32 	{%rs661, %rs662}, %r909;
	mov.b32 	{%rs663, %rs664}, %r910;
	mov.b32 	{%rs665, %rs666}, %r919;
	mov.b32 	{%rs667, %rs668}, %r920;
	mov.b32 	{%rs669, %rs670}, %r929;
	mov.b32 	{%rs671, %rs672}, %r930;
	mov.b32 	{%rs673, %rs674}, %r939;
	mov.b32 	{%rs675, %rs676}, %r940;
	mov.b32 	{%rs677, %rs678}, %r949;
	mov.b32 	{%rs679, %rs680}, %r950;
	mov.b32 	{%rs681, %rs682}, %r959;
	mov.b32 	{%rs683, %rs684}, %r960;
	mov.b32 	{%rs685, %rs686}, %r969;
	mov.b32 	{%rs687, %rs688}, %r970;
	mov.b32 	{%rs689, %rs690}, %r979;
	mov.b32 	{%rs691, %rs692}, %r980;
	mov.b32 	{%rs693, %rs694}, %r989;
	mov.b32 	{%rs695, %rs696}, %r990;
	mov.b32 	{%rs697, %rs698}, %r999;
	mov.b32 	{%rs699, %rs700}, %r1000;
	mov.b32 	{%rs701, %rs702}, %r1009;
	mov.b32 	{%rs703, %rs704}, %r1010;
	mov.b32 	{%rs705, %rs706}, %r1019;
	mov.b32 	{%rs707, %rs708}, %r1020;
	mov.b32 	{%rs709, %rs710}, %r1029;
	mov.b32 	{%rs711, %rs712}, %r1030;
	mov.b32 	{%rs713, %rs714}, %r1039;
	mov.b32 	{%rs715, %rs716}, %r1040;
	mov.b32 	{%rs717, %rs718}, %r1049;
	mov.b32 	{%rs719, %rs720}, %r1050;
	mov.b32 	{%rs721, %rs722}, %r1059;
	mov.b32 	{%rs723, %rs724}, %r1060;
	mov.b32 	{%rs725, %rs726}, %r1069;
	mov.b32 	{%rs727, %rs728}, %r1070;
	mov.b32 	{%rs729, %rs730}, %r1079;
	mov.b32 	{%rs731, %rs732}, %r1080;
	mov.b32 	{%rs733, %rs734}, %r1089;
	mov.b32 	{%rs735, %rs736}, %r1090;
	mov.b32 	{%rs737, %rs738}, %r1099;
	mov.b32 	{%rs739, %rs740}, %r1100;
	mov.b32 	{%rs741, %rs742}, %r1109;
	mov.b32 	{%rs743, %rs744}, %r1110;
	mov.b32 	{%rs745, %rs746}, %r1119;
	mov.b32 	{%rs747, %rs748}, %r1120;
	mov.b32 	{%rs749, %rs750}, %r1129;
	mov.b32 	{%rs751, %rs752}, %r1130;
	mov.b32 	{%rs753, %rs754}, %r1139;
	mov.b32 	{%rs755, %rs756}, %r1140;
	mov.b32 	{%rs757, %rs758}, %r1149;
	mov.b32 	{%rs759, %rs760}, %r1150;
	mov.b32 	{%rs761, %rs762}, %r1159;
	mov.b32 	{%rs763, %rs764}, %r1160;
	mov.b32 	{%rs765, %rs766}, %r1169;
	mov.b32 	{%rs767, %rs768}, %r1170;
	mov.b32 	{%rs769, %rs770}, %r1179;
	mov.b32 	{%rs771, %rs772}, %r1180;
	mov.b32 	{%rs773, %rs774}, %r1189;
	mov.b32 	{%rs775, %rs776}, %r1190;
	mov.b32 	{%rs777, %rs778}, %r1199;
	mov.b32 	{%rs779, %rs780}, %r1200;
	mov.b32 	{%rs781, %rs782}, %r1209;
	mov.b32 	{%rs783, %rs784}, %r1210;
	mov.b32 	{%rs785, %rs786}, %r1219;
	mov.b32 	{%rs787, %rs788}, %r1220;
	.loc	1 102 18
	...
	add.s32 	%r1418, %r1837, 1;
	setp.lt.s32 	%p142, %r1418, 2;
	selp.b32 	%r1837, %r1418, 0, %p142;
	.loc	1 96 53
	add.s32 	%r1419, %r1800, -16;
	.loc	1 96 72
	setp.lt.s32 	%p143, %r1419, %r203;
	setp.lt.s32 	%p144, %r1800, %r203;
	.loc	1 96 20
	shl.b32 	%r1420, %r1837, 13;
	...
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1229 + 0 ], [ %rd110 + 0 ], 0x10, %r1230;
	// end inline asm
	...
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1233 + 0 ], [ %rd112 + 0 ], 0x10, %r1236;
	// end inline asm
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1235 + 0 ], [ %rd113 + 0 ], 0x10, %r1236;
	// end inline asm
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1237 + 0 ], [ %rd114 + 0 ], 0x10, %r1236;
	// end inline asm
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1239 + 0 ], [ %rd115 + 0 ], 0x10, %r1236;
	// end inline asm
	// begin inline asm
	cp.async.commit_group ;
	// end inline asm
	.loc	1 93 22
	add.s32 	%r1435, %r1836, 1;
	setp.lt.s32 	%p146, %r1435, 2;
	selp.b32 	%r1836, %r1435, 0, %p146;
	.loc	1 96 20
	shl.b32 	%r1436, %r1836, 13;
	add.s32 	%r1835, %r493, %r1436;
	// begin inline asm
	cp.async.wait_group 0x2;
	// end inline asm
	bar.sync 	0;
	.loc	1 97 20
	shl.b32 	%r1437, %r1836, 14;
	add.s32 	%r1834, %r501, %r1437;
	.loc	1 96 20
	add.s32 	%r1245, %r1835, %r523;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16 { %r1830, %r1831, %r1832, %r1833 }, [ %r1245 + 0 ];
	// end inline asm
	add.s32 	%r1250, %r1835, %r527;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16 { %r1826, %r1827, %r1828, %r1829 }, [ %r1250 + 0 ];
	// end inline asm
	add.s32 	%r1255, %r1835, %r531;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16 { %r1822, %r1823, %r1824, %r1825 }, [ %r1255 + 0 ];
	// end inline asm
	add.s32 	%r1260, %r1835, %r535;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16 { %r1818, %r1819, %r1820, %r1821 }, [ %r1260 + 0 ];
	// end inline asm
	.loc	1 97 20
	add.s32 	%r1265, %r1834, %r541;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.shared.b16 { %r1814, %r1815, %r1816, %r1817 }, [ %r1265 + 0 ];
	// end inline asm
	add.s32 	%r1270, %r1265, 4096;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.shared.b16 { %r1810, %r1811, %r1812, %r1813 }, [ %r1270 + 0 ];
	// end inline asm
	add.s32 	%r1275, %r1265, 8192;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.shared.b16 { %r1806, %r1807, %r1808, %r1809 }, [ %r1275 + 0 ];
	// end inline asm
	add.s32 	%r1280, %r1265, 12288;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.shared.b16 { %r1802, %r1803, %r1804, %r1805 }, [ %r1280 + 0 ];
	// end inline asm
	.loc	1 93 22
...
$L__func_end0:
	...
	.file	1 "/home/mike/Desktop/Descite/llm.c/dev/triton/compile_matmul_kernel_bias_accumulate_transpose_a_transpose_b.py"
