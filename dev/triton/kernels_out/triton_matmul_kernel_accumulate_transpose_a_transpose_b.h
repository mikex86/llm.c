...
$L__BB0_2:
	...
	// end inline asm
	.loc	1 100 35
	mov.b32 	%r909, {%rs515, %rs516};
	mov.b32 	%r910, {%rs517, %rs518};
	mov.b32 	%r919, {%rs519, %rs520};
	mov.b32 	%r920, {%rs521, %rs522};
	mov.b32 	%r929, {%rs523, %rs524};
	mov.b32 	%r930, {%rs525, %rs526};
	mov.b32 	%r939, {%rs527, %rs528};
	mov.b32 	%r940, {%rs529, %rs530};
	mov.b32 	%r949, {%rs531, %rs532};
	mov.b32 	%r950, {%rs533, %rs534};
	mov.b32 	%r959, {%rs535, %rs536};
	mov.b32 	%r960, {%rs537, %rs538};
	mov.b32 	%r969, {%rs539, %rs540};
	mov.b32 	%r970, {%rs541, %rs542};
	mov.b32 	%r979, {%rs543, %rs544};
	mov.b32 	%r980, {%rs545, %rs546};
	mov.b32 	%r989, {%rs547, %rs548};
	mov.b32 	%r990, {%rs549, %rs550};
	mov.b32 	%r999, {%rs551, %rs552};
	mov.b32 	%r1000, {%rs553, %rs554};
	mov.b32 	%r1009, {%rs555, %rs556};
	mov.b32 	%r1010, {%rs557, %rs558};
	mov.b32 	%r1019, {%rs559, %rs560};
	mov.b32 	%r1020, {%rs561, %rs562};
	mov.b32 	%r1029, {%rs563, %rs564};
	mov.b32 	%r1030, {%rs565, %rs566};
	mov.b32 	%r1039, {%rs567, %rs568};
	mov.b32 	%r1040, {%rs569, %rs570};
	mov.b32 	%r1049, {%rs571, %rs572};
	mov.b32 	%r1050, {%rs573, %rs574};
	mov.b32 	%r1059, {%rs575, %rs576};
	mov.b32 	%r1060, {%rs577, %rs578};
	mov.b32 	%r1069, {%rs579, %rs580};
	mov.b32 	%r1070, {%rs581, %rs582};
	mov.b32 	%r1079, {%rs583, %rs584};
	mov.b32 	%r1080, {%rs585, %rs586};
	mov.b32 	%r1089, {%rs587, %rs588};
	mov.b32 	%r1090, {%rs589, %rs590};
	mov.b32 	%r1099, {%rs591, %rs592};
	mov.b32 	%r1100, {%rs593, %rs594};
	mov.b32 	%r1109, {%rs595, %rs596};
	mov.b32 	%r1110, {%rs597, %rs598};
	mov.b32 	%r1119, {%rs599, %rs600};
	mov.b32 	%r1120, {%rs601, %rs602};
	mov.b32 	%r1129, {%rs603, %rs604};
	mov.b32 	%r1130, {%rs605, %rs606};
	mov.b32 	%r1139, {%rs607, %rs608};
	mov.b32 	%r1140, {%rs609, %rs610};
	mov.b32 	%r1149, {%rs611, %rs612};
	mov.b32 	%r1150, {%rs613, %rs614};
	mov.b32 	%r1159, {%rs615, %rs616};
	mov.b32 	%r1160, {%rs617, %rs618};
	mov.b32 	%r1169, {%rs619, %rs620};
	mov.b32 	%r1170, {%rs621, %rs622};
	mov.b32 	%r1179, {%rs623, %rs624};
	mov.b32 	%r1180, {%rs625, %rs626};
	mov.b32 	%r1189, {%rs627, %rs628};
	mov.b32 	%r1190, {%rs629, %rs630};
	mov.b32 	%r1199, {%rs631, %rs632};
	mov.b32 	%r1200, {%rs633, %rs634};
	mov.b32 	%r1209, {%rs635, %rs636};
	mov.b32 	%r1210, {%rs637, %rs638};
	mov.b32 	%r1219, {%rs639, %rs640};
	mov.b32 	%r1220, {%rs641, %rs642};
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r909, %r910 }, { %r1803, %r1804, %r1805, %r1806 }, { %r1787, %r1788 }, { %r909, %r910 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r919, %r920 }, { %r1803, %r1804, %r1805, %r1806 }, { %r1789, %r1790 }, { %r919, %r920 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r929, %r930 }, { %r1803, %r1804, %r1805, %r1806 }, { %r1783, %r1784 }, { %r929, %r930 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r939, %r940 }, { %r1803, %r1804, %r1805, %r1806 }, { %r1785, %r1786 }, { %r939, %r940 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r949, %r950 }, { %r1803, %r1804, %r1805, %r1806 }, { %r1779, %r1780 }, { %r949, %r950 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r959, %r960 }, { %r1803, %r1804, %r1805, %r1806 }, { %r1781, %r1782 }, { %r959, %r960 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r969, %r970 }, { %r1803, %r1804, %r1805, %r1806 }, { %r1775, %r1776 }, { %r969, %r970 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r979, %r980 }, { %r1803, %r1804, %r1805, %r1806 }, { %r1777, %r1778 }, { %r979, %r980 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r989, %r990 }, { %r1799, %r1800, %r1801, %r1802 }, { %r1787, %r1788 }, { %r989, %r990 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r999, %r1000 }, { %r1799, %r1800, %r1801, %r1802 }, { %r1789, %r1790 }, { %r999, %r1000 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1009, %r1010 }, { %r1799, %r1800, %r1801, %r1802 }, { %r1783, %r1784 }, { %r1009, %r1010 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1019, %r1020 }, { %r1799, %r1800, %r1801, %r1802 }, { %r1785, %r1786 }, { %r1019, %r1020 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1029, %r1030 }, { %r1799, %r1800, %r1801, %r1802 }, { %r1779, %r1780 }, { %r1029, %r1030 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1039, %r1040 }, { %r1799, %r1800, %r1801, %r1802 }, { %r1781, %r1782 }, { %r1039, %r1040 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1049, %r1050 }, { %r1799, %r1800, %r1801, %r1802 }, { %r1775, %r1776 }, { %r1049, %r1050 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1059, %r1060 }, { %r1799, %r1800, %r1801, %r1802 }, { %r1777, %r1778 }, { %r1059, %r1060 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1069, %r1070 }, { %r1795, %r1796, %r1797, %r1798 }, { %r1787, %r1788 }, { %r1069, %r1070 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1079, %r1080 }, { %r1795, %r1796, %r1797, %r1798 }, { %r1789, %r1790 }, { %r1079, %r1080 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1089, %r1090 }, { %r1795, %r1796, %r1797, %r1798 }, { %r1783, %r1784 }, { %r1089, %r1090 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1099, %r1100 }, { %r1795, %r1796, %r1797, %r1798 }, { %r1785, %r1786 }, { %r1099, %r1100 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1109, %r1110 }, { %r1795, %r1796, %r1797, %r1798 }, { %r1779, %r1780 }, { %r1109, %r1110 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1119, %r1120 }, { %r1795, %r1796, %r1797, %r1798 }, { %r1781, %r1782 }, { %r1119, %r1120 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1129, %r1130 }, { %r1795, %r1796, %r1797, %r1798 }, { %r1775, %r1776 }, { %r1129, %r1130 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1139, %r1140 }, { %r1795, %r1796, %r1797, %r1798 }, { %r1777, %r1778 }, { %r1139, %r1140 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1149, %r1150 }, { %r1791, %r1792, %r1793, %r1794 }, { %r1787, %r1788 }, { %r1149, %r1150 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1159, %r1160 }, { %r1791, %r1792, %r1793, %r1794 }, { %r1789, %r1790 }, { %r1159, %r1160 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1169, %r1170 }, { %r1791, %r1792, %r1793, %r1794 }, { %r1783, %r1784 }, { %r1169, %r1170 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1179, %r1180 }, { %r1791, %r1792, %r1793, %r1794 }, { %r1785, %r1786 }, { %r1179, %r1180 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1189, %r1190 }, { %r1791, %r1792, %r1793, %r1794 }, { %r1779, %r1780 }, { %r1189, %r1190 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1199, %r1200 }, { %r1791, %r1792, %r1793, %r1794 }, { %r1781, %r1782 }, { %r1199, %r1200 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1209, %r1210 }, { %r1791, %r1792, %r1793, %r1794 }, { %r1775, %r1776 }, { %r1209, %r1210 };
	// end inline asm
	// begin inline asm
	mma.sync.aligned.m16n8k16.row.col.f16.f16.f16.f16 { %r1219, %r1220 }, { %r1791, %r1792, %r1793, %r1794 }, { %r1777, %r1778 }, { %r1219, %r1220 };
	// end inline asm
	// begin inline asm
	...
	// end inline asm
	mov.b32 	{%rs515, %rs516}, %r909;
	mov.b32 	{%rs517, %rs518}, %r910;
	mov.b32 	{%rs519, %rs520}, %r919;
	mov.b32 	{%rs521, %rs522}, %r920;
	mov.b32 	{%rs523, %rs524}, %r929;
	mov.b32 	{%rs525, %rs526}, %r930;
	mov.b32 	{%rs527, %rs528}, %r939;
	mov.b32 	{%rs529, %rs530}, %r940;
	mov.b32 	{%rs531, %rs532}, %r949;
	mov.b32 	{%rs533, %rs534}, %r950;
	mov.b32 	{%rs535, %rs536}, %r959;
	mov.b32 	{%rs537, %rs538}, %r960;
	mov.b32 	{%rs539, %rs540}, %r969;
	mov.b32 	{%rs541, %rs542}, %r970;
	mov.b32 	{%rs543, %rs544}, %r979;
	mov.b32 	{%rs545, %rs546}, %r980;
	mov.b32 	{%rs547, %rs548}, %r989;
	mov.b32 	{%rs549, %rs550}, %r990;
	mov.b32 	{%rs551, %rs552}, %r999;
	mov.b32 	{%rs553, %rs554}, %r1000;
	mov.b32 	{%rs555, %rs556}, %r1009;
	mov.b32 	{%rs557, %rs558}, %r1010;
	mov.b32 	{%rs559, %rs560}, %r1019;
	mov.b32 	{%rs561, %rs562}, %r1020;
	mov.b32 	{%rs563, %rs564}, %r1029;
	mov.b32 	{%rs565, %rs566}, %r1030;
	mov.b32 	{%rs567, %rs568}, %r1039;
	mov.b32 	{%rs569, %rs570}, %r1040;
	mov.b32 	{%rs571, %rs572}, %r1049;
	mov.b32 	{%rs573, %rs574}, %r1050;
	mov.b32 	{%rs575, %rs576}, %r1059;
	mov.b32 	{%rs577, %rs578}, %r1060;
	mov.b32 	{%rs579, %rs580}, %r1069;
	mov.b32 	{%rs581, %rs582}, %r1070;
	mov.b32 	{%rs583, %rs584}, %r1079;
	mov.b32 	{%rs585, %rs586}, %r1080;
	mov.b32 	{%rs587, %rs588}, %r1089;
	mov.b32 	{%rs589, %rs590}, %r1090;
	mov.b32 	{%rs591, %rs592}, %r1099;
	mov.b32 	{%rs593, %rs594}, %r1100;
	mov.b32 	{%rs595, %rs596}, %r1109;
	mov.b32 	{%rs597, %rs598}, %r1110;
	mov.b32 	{%rs599, %rs600}, %r1119;
	mov.b32 	{%rs601, %rs602}, %r1120;
	mov.b32 	{%rs603, %rs604}, %r1129;
	mov.b32 	{%rs605, %rs606}, %r1130;
	mov.b32 	{%rs607, %rs608}, %r1139;
	mov.b32 	{%rs609, %rs610}, %r1140;
	mov.b32 	{%rs611, %rs612}, %r1149;
	mov.b32 	{%rs613, %rs614}, %r1150;
	mov.b32 	{%rs615, %rs616}, %r1159;
	mov.b32 	{%rs617, %rs618}, %r1160;
	mov.b32 	{%rs619, %rs620}, %r1169;
	mov.b32 	{%rs621, %rs622}, %r1170;
	mov.b32 	{%rs623, %rs624}, %r1179;
	mov.b32 	{%rs625, %rs626}, %r1180;
	mov.b32 	{%rs627, %rs628}, %r1189;
	mov.b32 	{%rs629, %rs630}, %r1190;
	mov.b32 	{%rs631, %rs632}, %r1199;
	mov.b32 	{%rs633, %rs634}, %r1200;
	mov.b32 	{%rs635, %rs636}, %r1209;
	mov.b32 	{%rs637, %rs638}, %r1210;
	mov.b32 	{%rs639, %rs640}, %r1219;
	mov.b32 	{%rs641, %rs642}, %r1220;
	.loc	1 102 18
	...
	add.s32 	%r1418, %r1810, 1;
	setp.lt.s32 	%p142, %r1418, 2;
	selp.b32 	%r1810, %r1418, 0, %p142;
	.loc	1 96 53
	add.s32 	%r1419, %r1773, -16;
	.loc	1 96 72
	setp.lt.s32 	%p143, %r1419, %r201;
	setp.lt.s32 	%p144, %r1773, %r201;
	.loc	1 96 20
	shl.b32 	%r1420, %r1810, 13;
	...
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1229 + 0 ], [ %rd109 + 0 ], 0x10, %r1230;
	// end inline asm
	...
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1233 + 0 ], [ %rd111 + 0 ], 0x10, %r1236;
	// end inline asm
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1235 + 0 ], [ %rd112 + 0 ], 0x10, %r1236;
	// end inline asm
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1237 + 0 ], [ %rd113 + 0 ], 0x10, %r1236;
	// end inline asm
	// begin inline asm
	@%p97 cp.async.cg.shared.global [ %r1239 + 0 ], [ %rd114 + 0 ], 0x10, %r1236;
	// end inline asm
	// begin inline asm
	cp.async.commit_group ;
	// end inline asm
	.loc	1 93 22
	add.s32 	%r1435, %r1809, 1;
	setp.lt.s32 	%p146, %r1435, 2;
	selp.b32 	%r1809, %r1435, 0, %p146;
	.loc	1 96 20
	shl.b32 	%r1436, %r1809, 13;
	add.s32 	%r1808, %r493, %r1436;
	// begin inline asm
	cp.async.wait_group 0x2;
	// end inline asm
	bar.sync 	0;
	.loc	1 97 20
	shl.b32 	%r1437, %r1809, 14;
	add.s32 	%r1807, %r501, %r1437;
	.loc	1 96 20
	add.s32 	%r1245, %r1808, %r523;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16 { %r1803, %r1804, %r1805, %r1806 }, [ %r1245 + 0 ];
	// end inline asm
	add.s32 	%r1250, %r1808, %r527;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16 { %r1799, %r1800, %r1801, %r1802 }, [ %r1250 + 0 ];
	// end inline asm
	add.s32 	%r1255, %r1808, %r531;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16 { %r1795, %r1796, %r1797, %r1798 }, [ %r1255 + 0 ];
	// end inline asm
	add.s32 	%r1260, %r1808, %r535;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16 { %r1791, %r1792, %r1793, %r1794 }, [ %r1260 + 0 ];
	// end inline asm
	.loc	1 97 20
	add.s32 	%r1265, %r1807, %r541;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.shared.b16 { %r1787, %r1788, %r1789, %r1790 }, [ %r1265 + 0 ];
	// end inline asm
	add.s32 	%r1270, %r1265, 4096;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.shared.b16 { %r1783, %r1784, %r1785, %r1786 }, [ %r1270 + 0 ];
	// end inline asm
	add.s32 	%r1275, %r1265, 8192;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.shared.b16 { %r1779, %r1780, %r1781, %r1782 }, [ %r1275 + 0 ];
	// end inline asm
	add.s32 	%r1280, %r1265, 12288;
	// begin inline asm
	ldmatrix.sync.aligned.m8n8.x4.shared.b16 { %r1775, %r1776, %r1777, %r1778 }, [ %r1280 + 0 ];
	// end inline asm
	.loc	1 93 22
...
$L__func_end0:
	...
	.file	1 "/home/mike/Desktop/Descite/llm.c/dev/triton/compile_matmul_kernel_accumulate_transpose_a_transpose_b.py"
